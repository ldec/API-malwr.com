...
class MalwrAPI(object):
    ...
    def __init__(self, verbose=False, username=None, password=None, apikey=None, cookie=None):
    ...
    def login(self):
        ...
        if self.username and self.password:
            ...
            response = self.session.get(self.url + "/account/login/",
                                              data=payload, headers=self.headers)

            self.cookie=response.cookies["sessionid"]
